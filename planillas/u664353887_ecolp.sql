...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-06-2017 a las 17:24:05
...
CREATE TABLE `mascotas` (
  ...
  `mascotas_peso` int(11) DEFAULT NULL,
...
INSERT INTO `mascotas` (`mascotas_id`, `mascotas_nombre`, `mascotas_peso`, `id_tipo`, `mascotas_raza`, `mascotas_fdef`, `mascotas_edad`, `propietarios_id`) VALUES
(111, 'Junior', 5, 1, 'chihuahua', '04/06/2017', 20, 64);
...
(23, 2, 111, 64, 62, '04/06/2017', '04/06/2017', '', 11, 6, 4);
...
CREATE TABLE `propietarios` (
  `propietarios_id` int(11) NOT NULL,
  `propietarios_doc` int(11) DEFAULT '0',
...
(64, 9412468, 'Camilo', 'Contreras S.', '+584141266763', NULL);
...
INSERT INTO `recepcion` (`recepcion_id`, `referidos_id`, `propietarios_id`, `mascotas_id`, `devolucion_id`, `planes_id`, `urna_id`, `id_tipo`, `recepcion_fecha`, `fecha_programada`) VALUES
(7, 62, 64, 111, 1, 2, 5, 1, '04/06/2017', '08/06/2017');
...
(62, 'ultima prueba', '+584141266763', 'pielcuidada@gmail.com');
...
--
ALTER TABLE `mascotas`
  MODIFY `mascotas_id` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=112;
--
...
--
ALTER TABLE `procesos`
  MODIFY `procesos_id` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
--
-- AUTO_INCREMENT de la tabla `propietarios`
--
ALTER TABLE `propietarios`
  MODIFY `propietarios_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;
--
-- AUTO_INCREMENT de la tabla `recepcion`
--
ALTER TABLE `recepcion`
  MODIFY `recepcion_id` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT de la tabla `referidos`
--
ALTER TABLE `referidos`
  MODIFY `referidos_id` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=63;
--
